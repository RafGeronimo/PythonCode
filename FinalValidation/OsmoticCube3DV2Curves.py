...
df_FEBio_disp_mag = pd.read_csv('FEBio_disp_mag1.txt', delim_whitespace = True)
df_FEBio_pressure = pd.read_csv('FEBio_pressure1.txt', delim_whitespace = True)
...
df_CEOS_disp_mag = pd.read_csv('CEOS_disp_mag1.dat', delim_whitespace = True)
df_CEOS_pressure = pd.read_csv('CEOS_pressure1.dat', delim_whitespace = True)
