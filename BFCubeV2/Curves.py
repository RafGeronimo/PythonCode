...
plt.plot(FEBio_time, FEBio_stress, 'b', label='FEBio', marker = '*')
plt.plot(CEOS_time, CEOS_stress, 'r', label = 'CEOS', marker = '.')
plt.title('Tensão efetiva x tempo')
plt.xlabel('Tempo')
plt.ylabel('Tensão efetiva')
plt.legend()
plt.show()